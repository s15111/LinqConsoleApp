    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad2()
        {
            ...
            var res2 = Emps.Where(emp => emp.Job == "Frontend programmer" && emp.Salary > 1000).OrderByDescending(emp => emp.Ename).Select(emp => new
            {
                Nazwisko = emp.Ename,
                Zawod = emp.Job
            });
        ...
        public void Przyklad10Button_Click()
        {
            ...
            //        from emp in Emps select new { "Brak wartości", null, a = null }
            //    );
        ...
        public void Przyklad12()
        {
            ...
            var res2 = Emps.SelectMany(emp => Emps.Select( emp2 => Tuple.Create( emp, emp2)));
